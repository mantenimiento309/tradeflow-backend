...
async function loadMyDashboard() {
  ...
  const [shipmentsData, alertsData, firmData] = await Promise.all([API.shipments(), API.fdaAlerts(), API.fdaFirm(user?.company || '')]);
        ...
        <div class="panel">
          ...
          <div class="panel-body">
            <div style="margin-bottom:10px">
              ...
              ${onFdaList ? `<div style="font-family:var(--font-display);font-size:22px;font-weight:700;color:var(--red)">${firmRefusals.length} rechazo(s)</div><div style="font-size:11px;color:var(--red);margin-top:2px;font-weight:600">Su empresa aparece en registros FDA</div>` : `<div style="font-family:var(--font-display);font-size:22px;font-weight:700;color:var(--green)">Limpio</div><div style="font-size:11px;color:var(--ink3);margin-top:2px">Su empresa no aparece en registros FDA</div>`}
            </div>
            <div style="margin-bottom:10px">
